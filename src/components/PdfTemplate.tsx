...
const TOOL_PATHS: Record<string, string> = {
  ...
  Hermes:      'M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v13A2.5 2.5 0 0 1 17.5 21h-11A2.5 2.5 0 0 1 4 18.5zM8 8v8h2v-3h4v3h2V8h-2v3h-4V8z',
  Codex:       'M8.7 7.3 4 12l4.7 4.7 1.4-1.4L6.8 12l3.3-3.3zm6.6 0-1.4 1.4 3.3 3.3-3.3 3.3 1.4 1.4L20 12zm-2.2-1.1-3.8 11.4 1.9.6L15 6.8z',
          ...
          <section className="mt-auto pt-4 border-t border-zinc-100">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-2.5">
                  {data.tools.filter(t => ["ChatGPT", "Claude", "Gemini", "Hermes", "Codex", "Antigravity"].includes(t.name)).map((tool, idx) => (
                    <div key={idx} className="flex items-start gap-2.5">
                      <div className="text-[#1A1A1A] shrink-0 pt-0.5" style={{ transform: 'scale(0.8)', transformOrigin: 'top left', width: '20px', height: '20px' }}>{renderToolIcon(tool.name)}</div>
                      <div className="flex flex-col">
                        <span className="text-[10px] font-bold text-[#1A1A1A]">{tool.name}</span>
